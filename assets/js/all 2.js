...
$(document).ready(function () {
  ...
  $('.js-country').click(function () {
    var select = $(this).children(".js-countrytext").data('country');
    console.log(select);
  ...
  $('.js-minus').click(function (e) {
    e.preventDefault();
    var quantity = parseInt($(this).next('input[type=number]').val());
  ...
  $('.js-plus').click(function (e) {
    e.preventDefault();
    var quantity = parseInt($(this).prev('input[type=number]').val());
    quantity = quantity + 1;
  ...
  $('.js-form-quantity').click(function () {
    ...
    var child = $('.js-child').val();
    var room = $('.js-room').val();
  ...
  $('.js-room-quantity').click(function () {
    $('.js-price').slideDown();
    var roomA_num = parseInt($('.js-roomA').val());
    var roomB_num = parseInt($('.js-roomB').val());
    var roomC_num = parseInt($('.js-roomC').val());
    var roomA_price = parseInt($('.js-roomA').data('price'));
    var roomB_price = parseInt($('.js-roomB').data('price'));
    var roomC_price = parseInt($('.js-roomC').data('price'));
    var room = roomA_num + roomB_num + roomC_num;
    var roomPrice = (roomA_price * roomA_num + roomB_price * roomB_num + roomC_price * roomC_num) * 2;
  ...
  $(function () {
    ...
    $('a[data-toggle="date"]').on('apply.daterangepicker', function (ev, picker) {
      ...
      var startmonth = month[parseInt(picker.startDate.format('MM')) - 1];
      var startDay = startDate + ' ' + startmonth;
      var endDate = picker.endDate.format('DD');
      var endmonth = month[parseInt(picker.endDate.format('MM')) - 1];
      var endDay = endDate + ' ' + endmonth;
  ...
  $('.js-formcheck').click(function (e) {
    e.preventDefault();
    var name = $('.js-reservation-name').val();
    var email = $('.js-reservation-email').val();
